...
function esPositivo(numero) {
  //La función va a recibir un entero. Devuelve como resultado l número es positivo o negativo. una cadena de texto que indica si e
